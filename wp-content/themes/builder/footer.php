...
<div class="ms-wrap-video">
    <img class="ms-lazy" src="<?php echo isset($temporalImage) ? $temporalImage : ''; ?>" alt="Lorem Ipsum"
        data-real-type="image" data-img="<?php echo builder_get_assets_path(); ?>/images/home/logo.png" width="1"
        height="1">
    <div class="ms-wrap-data">
        ...
        <div class="ms-social">
            ...
            <a href="<?php echo $flex_idx_info["social"]["facebook_social_url"]; ?>" class="ms-link idx-icon-facebook"
                title="Navigate to Facebook" target="_blank" rel="nofollow"><span>Facebook</span></a>
            <?php endif; ?>
            ...
            <a href="<?php echo $flex_idx_info["social"]["twitter_social_url"]; ?>" class="ms-link idx-icon-twitter"
                title="Navigate to Twitter" target="_blank" rel="nofollow"><span>Twitter</span></a>
            <?php endif; ?>
            ...
            <a href="<?php echo $flex_idx_info["social"]["gplus_social_url"]; ?>" class="ms-link idx-icon-google-plus"
                title="Navigate to Google+" target="_blank" rel="nofollow"><span>Google+</span></a>
            <?php endif; ?>
            ...
            <a href="<?php echo $flex_idx_info["social"]["instagram_social_url"]; ?>" class="ms-link idx-icon-instagram"
                title="Navigate to Instagram" target="_blank" rel="nofollow"><span>Instagram</span></a>
            <?php endif; ?>
            ...
            <a href="<?php echo $flex_idx_info["social"]["linkedin_social_url"]; ?>" class="ms-link idx-icon-linkedin2"
                title="Navigate to Linked In" target="_blank" rel="nofollow"><span>Linked In</span></a>
            <?php endif; ?>
    ...
    <div class="ms-video-footer">
        <div class="ms-wrap-img">
            <img class="ms-lazy" src="<?php echo isset($temporalImage) ? $temporalImage : ""; ?>" alt="Lorem Ipsum"
                data-real-type="image" data-img="<?php echo builder_get_assets_path(); ?>/images/home/video-bg.jpg"
                width="1" height="1">
