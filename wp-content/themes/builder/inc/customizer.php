...
function twentyfifteen_customize_control_js() {
	wp_enqueue_script( 'color-scheme-control', builder_get_assets_path() . '/js/color-scheme-control.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20141216', true );
...
function twentyfifteen_customize_preview_js() {
	wp_enqueue_script( 'twentyfifteen-customize-preview', builder_get_assets_path() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
