...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <link rel="stylesheet preload prefetch" as="style" href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700;800&display=swap">
    <link rel="preload" as="font" type="font/ttf" href="<?php echo get_site_url(); ?>/wp-content/plugins/idxboost/fonts/icons/fonts/idx-icons.ttf?j9u9ce" crossorigin>   
    <link rel="preload" as="style" href="<?php echo get_site_url(); ?>/wp-content/plugins/idxboost/fonts/icons/style.css">
      ...
      <div class="ms-wrap-header">
        <div class="ms-top-header">
            ...
            <div class="ms-login-access">
              ...
              <ul class="item-no-hea item-header" id="user-options">
                ...
                <li class="register" data-modal="modal_login" data-tab="tabRegister">
                  <button class="lg-register ms-btn-login ms-register" aria-label="<?php echo __('Register', IDXBOOST_DOMAIN_THEME_LANG); ?>">
              ...
              <ul class="item-lo-hea item-header" id="user-options">
                ...
                <li class="login show_modal_login_active">
                  <a href="javascript:void(0)" rel="nofollow" title="<?php echo __('Welcome', IDXBOOST_DOMAIN_THEME_LANG); ?>  <?php echo $lead_name_exp[0]; ?>"><?php echo __('Welcome', IDXBOOST_DOMAIN_THEME_LANG); ?>  <?php echo $lead_name_exp[0]; ?></a>
                  ...
                  <ul>
                    ...
                    <?php endforeach; ?>
                    <li><button class="flex-logout-link" id="flex-logout-link" title="<?php echo __('Logout', IDXBOOST_DOMAIN_THEME_LANG); ?>"><?php echo __('Logout', IDXBOOST_DOMAIN_THEME_LANG); ?></button></li>
                  </ul>
                  <?php endif; ?>
                  </div>
                </li>
          ...
          <div class="ms-item ms-wp-contact">
            <div class="ms-contact-info">
              ...
              <a href="mailto:<?php echo $idx_contact_email; ?>" class="ms-btn-email" title="<?php echo __('Email contact', IDXBOOST_DOMAIN_THEME_LANG); ?>"><span><?php echo __('Email', IDXBOOST_DOMAIN_THEME_LANG); ?></span></a>
            </div>
          </div>
          <!-- FINAL CONTACTO -->
        </div>
        ...
        <div class="ms-middle-header">
          ...
          <div class="ms-item">
            ...
            <!-- INICIO BOTON SEARCH -->
            <a href="/search" class="ms-btn-search" title="<?php echo __('Search a Property', IDXBOOST_DOMAIN_THEME_LANG); ?>">
              <span></span>
